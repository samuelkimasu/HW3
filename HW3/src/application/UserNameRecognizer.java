	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// requires alphabetical character to go to state 1
			...
			case 1: 
				...
				//  2: a period, minus, underscore that transitions to state 2 
			...
			case 2: 
				// State 2 deals with 2 transitions:
				// 1: a character after a period, minus, or underscore in the name
				// 2: another period, minus, or underscore after a period, minus, or underscore
		...
		case 2:
			...
			// If we end in State 2 that means the requirement of "allow minus signs and underscore
			// as well as period characters BETWEEN subsequent alphanumeric characters" was not met
			userNameRecognizerErrorMessage +=
				"A special character such as -._ must be followed "
				+ "by an alphanumeric character such as A-Z, a-z, 0-9\n";
			return userNameRecognizerErrorMessage;
